...
class Company extends BaseModel
{
    ...
    protected $hidden = ['id', 'currency_id', 'warehouse_id', 'admin_id', 'subscription_plan_id', 'updated_at'];

    protected $appends = ['xid', 'x_currency_id', 'x_warehouse_id', 'x_admin_id', 'x_subscription_plan_id', 'login_image_url', 'light_logo_url', 'dark_logo_url', 'small_light_logo_url', 'small_dark_logo_url', 'beep_audio_url'];
